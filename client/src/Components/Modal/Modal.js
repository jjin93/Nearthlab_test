  ...
  return (
    <ReactModal isOpen={isOpen} style={modalStyles} ariaHideApp={false}>
      <div className="flex flex-row gap-6 mt-4 mb-4">
        ...
        <button class="btn btn-circle btn-outline ml-10" onClick={handleClickCancel}>
      ...
      <div className="flex flex-row gap-4">
        ...
        <div className="basis-2/3">
          ...
          {isCompleted ? (
            <DoneIcon className="w-20 h-8 object-contain mt-10 ml-96 mr-3" onClick={changeCompleted} />
          ) : (
